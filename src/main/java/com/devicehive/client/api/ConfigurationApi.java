...
public interface ConfigurationApi {
  ...
  Void setProperty(
    @Path("name") String name, @retrofit.http.Body com.devicehive.client.model.Body body
  );
  ...
  @PUT("/configuration/{name}")
  void setProperty(
          @Path("name") String name, @retrofit.http.Body com.devicehive.client.model.Body body, Callback<Void> cb
  );
