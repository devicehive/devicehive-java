...
import com.devicehive.client.model.DeviceInfo;
...
public interface DeviceApi {
    ...
    List<DeviceInfo> list(
            ...
            @Query("deviceClassId") Long deviceClassId,
            @Query("deviceClassName") String deviceClassName,
            @Query("deviceClassVersion") String deviceClassVersion,
    ...
    void equipment(
            @Path("id") String id,
            Callback<List<DeviceEquipment>> cb
    );
