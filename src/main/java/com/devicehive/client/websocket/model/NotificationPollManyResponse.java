...
import static com.devicehive.client.websocket.json.strategies.JsonPolicyDef.Policy.NOTIFICATION_TO_CLIENT;
...
public class NotificationPollManyResponse implements HiveEntity {
    ...
    private com.devicehive.client.websocket.model.DeviceNotification notification;

    @SerializedName("deviceGuid")
    @JsonPolicyDef(NOTIFICATION_TO_CLIENT)
    private String guid;

    public NotificationPollManyResponse(com.devicehive.client.websocket.model.DeviceNotification notification, String guid) {
    ...
    public com.devicehive.client.websocket.model.DeviceNotification getNotification() {
        return notification;
    }
