...
import io.swagger.client.model.DeviceCommandResponse;
...
public interface DeviceCommandApi {
    ...
    @POST("/device/{deviceGuid}/command")
    void insert(
            @Path("deviceGuid") String deviceGuid, @Body DeviceCommandWrapper body, Callback<DeviceCommandResponse> cb
    );
    ...
    @GET("/device/{deviceGuid}/command/poll")
    void poll(
            @Path("deviceGuid") String deviceGuid, @Query("names") String names, @Query("timestamp") String timestamp, @Query("waitTimeout") Long waitTimeout, Callback<List<DeviceResponse>> cb
    );
    ...
    @PUT("/device/{deviceGuid}/command/{commandId}")
    void update(
            @Path("deviceGuid") String deviceGuid, @Path("commandId") Long commandId, @Body DeviceCommandWrapper body, Callback<Void> cb
    );
