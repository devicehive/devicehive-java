...
public interface JwtTokenApi {
  ...
  @POST("token")
  Call<com.github.devicehive.rest.model.JwtToken> login(
  ...
  @POST("token/refresh")
  Call<com.github.devicehive.rest.model.JwtAccessToken> refreshTokenRequest(
          @Body com.github.devicehive.rest.model.JwtRefreshToken refreshToken
  );
  ...
  @POST("token/create")
  Call<com.github.devicehive.rest.model.JwtToken> tokenRequest(
